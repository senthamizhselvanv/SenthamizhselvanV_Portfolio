export const projects = [
  {
    ...
    description:
      "Enterprise Disaster Recovery Management platform developed using JavaScript jQuery and ASP.NET Web API and multiple business modules.",
    longDescription:
      "Worked as a UI Developer on a large-scale Disaster Recovery Management platform. Initially developed features using React.js and later contributed extensively using JavaScript and jQuery after the application migrated. Built 10+ enterprise modules, implemented reusable UI components, performed CRUD operations, resolved production issues and collaborated with backend teams throughout the software lifecycle.",
    image: "/images/project-drm.jpg",
    technologies: ["JavaScript", "jQuery", "ASP.NET Web API", "TortoiseSVN"],
...

  {
    ...
    technologies: ["React.js", "React Hooks", "REST API", "ASP.NET Web API", "Git"],
    category: "Enterprise Web Application",
    features: [
...

  {
    ...
    technologies: ["Visual Basic", "Windows Presentation Fountation"],
